...
import Legacy from '../lib/sources/tiles-arii';
import Geokerbin from '../lib/sources/tiles-iriatai';
...
export default {
    ...
    mounted() {
        ...
        Map.addKerbalLayer(Geokerbin, Geokerbin.kerbin.sat, { id: 0, visible: true })
